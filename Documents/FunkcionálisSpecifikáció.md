...
# 13. Fogalomszótár
HTML: egy leíró nyelv, amit weboldalak készítéséhez fejlesztettek ki.</br>
CSS: egy stílusleíró nyelv, mely a HTML vagy XHTML típusú strukturált dokumentumok megjelenését írja le.</br>
Java Script: egy objektumorientált programozási nyelv, prototípus alapú szkriptnyelv, amelyet weboldalakon elterjedten használnak.</br>
