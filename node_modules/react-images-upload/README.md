...
| label | String | Maximális feltölthető méret: 5mb, elfogadott fájltípusok: jpg, gif, png, gif' | Label text |
...
| fileSizeError | String | " Fájl mérete túl nagy" | Label for file size error message. |
| fileTypeError | String | " Nem támogatott fájl formátum" | Label for file extension error message. |
